  ...
  return <section className="py-12 md:py-20 px-4 bg-gradient-to-br from-primary/5 to-accent/5">
      <div className="container mx-auto max-w-3xl text-center space-y-6">
        <h2 className="text-xl md:text-2xl font-bold text-foreground leading-tight">
          Garanta já o seu Combo do Emagrecimento e garanta acesso à oferta antes de todo mundo.
        </h2>

        <p className="text-base text-foreground/80 leading-relaxed">
          Oferta válida apenas para os 100 primeiros que                   <strong className="text-primary">entrarem no Combo do Emagrecimento. </strong>. Não haverá repetição desse valor nem dos bônus.
        </p>
