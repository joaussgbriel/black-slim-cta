...
const FinalCTA = () => {
  return <section className="py-12 md:py-20 px-4 bg-gradient-to-br from-primary/5 to-accent/5">
      <div className="container mx-auto max-w-3xl text-center space-y-6">
        ...
        <div className="pt-4">
          <Button size="lg" className="w-full sm:w-auto bg-primary hover:bg-primary/90 text-primary-foreground font-bold text-base px-4 py-6 shadow-xl hover:shadow-2xl transition-all" onClick={() => window.open("https://pay.hotmart.com/K103127855R", "_blank")}>
            GARANTIR COMBO
          </Button>
        </div>
