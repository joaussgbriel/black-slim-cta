      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="space-y-4">
          {benefits.map((benefit, index) => (
            <div key={index} className="flex gap-3 items-start bg-card p-5 rounded-lg shadow-sm">
